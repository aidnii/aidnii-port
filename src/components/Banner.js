...
import headerImg from "../assets/img/header-img-gray.svg";
import 'animate.css';
          ...
          <Col xs={12} md={6} xl={7}>
                ...
                {({ isVisible }) => 
                  <div className={ isVisible ? "animated__animated animate_fadeIn" : ""}>
                    ...
                    <a href="https://drive.google.com/file/d/1VgPaxjPsMqyQsY-moiHZj2ZIpy34SZzv/view?usp=sharing" className="btn">download CV</a>
